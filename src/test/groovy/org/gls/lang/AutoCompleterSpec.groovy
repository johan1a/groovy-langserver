...
class AutoCompleterSpec extends Specification {
    ...
    def "AutoComplete"() {
        ...
        classDefinition.memberFunctions.add(makeFuncDefinition(_funcName))
        classDefinition.memberFunctions.add(makeFuncDefinition("bFunc"))
    ...
    private FuncDefinition makeFuncDefinition(String name) {
