...
class AutoCompleterSpec extends Specification {
    ...
    void "Autocomplete 2"() {
        given:
            ...
            String filePath = new File(path).canonicalPath
        ...
        when:
            ...
            CompletionRequest request = new CompletionRequest(position: _pos, precedingText: _preceding,
                    uri: new File(path).canonicalPath)
